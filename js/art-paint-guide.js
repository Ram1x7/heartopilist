...
// そのため、上下左右だけでなく斜めも含めた周囲8マス全てが同じ色で囲まれている
// マスだけを「内側マス」とし、それ以外（周囲8マスのどこかに違う色や未着色がある）
// は先に1マスずつ塗って壁を作っておく「境目マス」として扱う。
//
//   ・完成図で周囲8マスのどこかに違う色（または未着色）がある＝「境目マス」→ 1マスずつタップ
//   ・周囲8マスが全部同じ色＝「内側マス」→ 境目を塗った後ならバケツでまとめて塗れる
//
...
// ── マスの分類 ──
// 完成図の各マスについて、周囲8マス（斜め含む）のいずれかが違う色（または未着色）
// なら「境目マス」、周囲8マス全てが同じ色なら「内側マス」とし、色ごとに集計する。
// 斜めだけの隙間から漏れる可能性を防ぐため、上下左右の4方向だけでなく斜め4方向も
// 必ずチェックする
