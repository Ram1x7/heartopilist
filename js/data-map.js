...
const mapLandmarks = [
  ...
  { key:"Meadow Lake", name:"草原の湖", nameI18n:{"ja":"草原の湖","en":"Meadow Lake","zh-CN":"","zh-TW":"","ko":"","th":""}, x:23.43, y:53.36 },
...
const mapPois = [
  ...
  { key:"Research Lab", name:"研究室", nameI18n:{"ja":"研究室","en":"Research Lab","zh-CN":"","zh-TW":"","ko":"","th":""}, x:47.29, y:48.85, icon:"images/map/poi/research-lab.png" },
];

const mapNpcs = [
  { key:"bob", name:"ボブおじさん", x:50.15, y:46.8 },
  { key:"atara", name:"アタラ", x:49.55, y:52.5 },
  { key:"collector", name:"収集家", x:36.6, y:47.45 },
  { key:"dorothee", name:"ドロシー", x:48.95, y:47.05 },
  { key:"massimo", name:"マッシモ", x:48.6, y:44.2 },
  { key:"ka-ching", name:"カー・チン", x:41.85, y:41.4 },
  { key:"andrew", name:"アンドリュー", x:59.05, y:40.0 },
  { key:"eric", name:"エリック", x:51.45, y:25.75 },
  { key:"vanya", name:"ヴァンニア", x:54.85, y:45.4 },
  { key:"naniwa", name:"浪花", x:59.2, y:50.4 },
  { key:"mrs-joan", name:"ジョーンさん", x:52.35, y:49.9 },
  { key:"will", name:"ウィル", x:41.95, y:79.75 },
  { key:"patty", name:"パティ", x:82.7, y:35.5 },
  { key:"vernie", name:"バーニー", x:21.3, y:65.8 },
  { key:"annie", name:"アニー", x:49.05, y:49.75 },
  { key:"bailey-j", name:"ベイリー", x:53.0, y:50.05 },
  { key:"bill", name:"ビル", x:44.5, y:73.05 },
  { key:"doris", name:"ドリス", x:41.2, y:50.8 },
  { key:"blanc", name:"ブランク", x:56.85, y:53.5 },
  { key:"azure", name:"アズール", x:47.71, y:47.54 },
  { key:"albart", name:"アルバート二世", x:61.32, y:42.3 },
  // 熱気球イベント（2件、x:17.05, y:39.35/39.95）の間に配置
  { key:"shonen", name:"遠くを眺める少年", x:17.05, y:39.65 },
];

const mapShops = [
  { key:"clothes-store", name:"服屋", x:48.7, y:47.2 },
  { key:"furniture-store", name:"家具店", x:50.3, y:47.4 },
  { key:"pets-store", name:"ペットの家", x:52.05, y:49.65 },
...
const mapEvents = [
  ...
  // （北側＝上、南側＝下）
  { key:"hot-air-balloon", name:"熱気球・町一周クルーズ", x:17.05, y:39.35 },
  { key:"hot-air-balloon", name:"熱気球・花畑クルーズ", x:17.05, y:39.95 },
];
