...
const CACHE_NAME = "hatopi-v2.296.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=55",
  "./locales/en.json?v=55",
  "./locales/ko.json?v=55",
  "./locales/th.json?v=55",
  "./locales/zh-CN.json?v=55",
  "./locales/zh-TW.json?v=55",
  "./manifest.json",
];
