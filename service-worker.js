...
const CACHE_NAME = "hatopi-v2.181.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=18",
  "./locales/en.json?v=18",
  "./locales/ko.json?v=18",
  "./locales/th.json?v=18",
  "./locales/zh-CN.json?v=18",
  "./locales/zh-TW.json?v=18",
  "./manifest.json",
];
