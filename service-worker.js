...
const CACHE_NAME = "hatopi-v2.245.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=42",
  "./locales/en.json?v=42",
  "./locales/ko.json?v=42",
  "./locales/th.json?v=42",
  "./locales/zh-CN.json?v=42",
  "./locales/zh-TW.json?v=42",
  "./manifest.json",
];
