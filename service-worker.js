...
const CACHE_NAME = "hatopi-v2.243.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=40",
  "./locales/en.json?v=40",
  "./locales/ko.json?v=40",
  "./locales/th.json?v=40",
  "./locales/zh-CN.json?v=40",
  "./locales/zh-TW.json?v=40",
  "./manifest.json",
];
