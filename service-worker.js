...
const CACHE_NAME = "hatopi-v2.215.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=36",
  "./locales/en.json?v=36",
  "./locales/ko.json?v=36",
  "./locales/th.json?v=36",
  "./locales/zh-CN.json?v=36",
  "./locales/zh-TW.json?v=36",
  "./manifest.json",
];
