...
const CACHE_NAME = "hatopi-v2.182.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=19",
  "./locales/en.json?v=19",
  "./locales/ko.json?v=19",
  "./locales/th.json?v=19",
  "./locales/zh-CN.json?v=19",
  "./locales/zh-TW.json?v=19",
  "./manifest.json",
];
