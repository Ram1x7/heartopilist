...
const CACHE_NAME = "hatopi-v2.246.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=43",
  "./locales/en.json?v=43",
  "./locales/ko.json?v=43",
  "./locales/th.json?v=43",
  "./locales/zh-CN.json?v=43",
  "./locales/zh-TW.json?v=43",
  "./manifest.json",
];
