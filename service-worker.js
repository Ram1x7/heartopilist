...
const CACHE_NAME = "hatopi-v2.248.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=45",
  "./locales/en.json?v=45",
  "./locales/ko.json?v=45",
  "./locales/th.json?v=45",
  "./locales/zh-CN.json?v=45",
  "./locales/zh-TW.json?v=45",
  "./manifest.json",
];
