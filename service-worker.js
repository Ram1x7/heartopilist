...
const CACHE_NAME = "hatopi-v2.189.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=23",
  "./locales/en.json?v=23",
  "./locales/ko.json?v=23",
  "./locales/th.json?v=23",
  "./locales/zh-CN.json?v=23",
  "./locales/zh-TW.json?v=23",
  "./manifest.json",
];
