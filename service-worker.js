...
const CACHE_NAME = "hatopi-v2.187.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=22",
  "./locales/en.json?v=22",
  "./locales/ko.json?v=22",
  "./locales/th.json?v=22",
  "./locales/zh-CN.json?v=22",
  "./locales/zh-TW.json?v=22",
  "./manifest.json",
];
