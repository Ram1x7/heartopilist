...
const CACHE_NAME = "hatopi-v2.298.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=56",
  "./locales/en.json?v=56",
  "./locales/ko.json?v=56",
  "./locales/th.json?v=56",
  "./locales/zh-CN.json?v=56",
  "./locales/zh-TW.json?v=56",
  "./manifest.json",
];
