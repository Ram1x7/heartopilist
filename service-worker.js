...
const CACHE_NAME = "hatopi-v2.265.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=52",
  "./locales/en.json?v=52",
  "./locales/ko.json?v=52",
  "./locales/th.json?v=52",
  "./locales/zh-CN.json?v=52",
  "./locales/zh-TW.json?v=52",
  "./manifest.json",
];
