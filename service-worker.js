...
const CACHE_NAME = "hatopi-v2.208.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=31",
  "./locales/en.json?v=31",
  "./locales/ko.json?v=31",
  "./locales/th.json?v=31",
  "./locales/zh-CN.json?v=31",
  "./locales/zh-TW.json?v=31",
  "./manifest.json",
];
