...
const CACHE_NAME = "hatopi-v2.198.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=30",
  "./locales/en.json?v=30",
  "./locales/ko.json?v=30",
  "./locales/th.json?v=30",
  "./locales/zh-CN.json?v=30",
  "./locales/zh-TW.json?v=30",
  "./manifest.json",
];
