...
const CACHE_NAME = "hatopi-v2.191.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=25",
  "./locales/en.json?v=25",
  "./locales/ko.json?v=25",
  "./locales/th.json?v=25",
  "./locales/zh-CN.json?v=25",
  "./locales/zh-TW.json?v=25",
  "./manifest.json",
];
