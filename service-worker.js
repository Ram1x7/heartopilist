...
const CACHE_NAME = "hatopi-v2.370.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=58",
  "./locales/en.json?v=58",
  "./locales/ko.json?v=58",
  "./locales/th.json?v=58",
  "./locales/zh-CN.json?v=58",
  "./locales/zh-TW.json?v=58",
  "./manifest.json",
];
