...
const CACHE_NAME = "hatopi-v2.190.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=24",
  "./locales/en.json?v=24",
  "./locales/ko.json?v=24",
  "./locales/th.json?v=24",
  "./locales/zh-CN.json?v=24",
  "./locales/zh-TW.json?v=24",
  "./manifest.json",
];
