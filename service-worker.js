...
const CACHE_NAME = "hatopi-v2.183.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=20",
  "./locales/en.json?v=20",
  "./locales/ko.json?v=20",
  "./locales/th.json?v=20",
  "./locales/zh-CN.json?v=20",
  "./locales/zh-TW.json?v=20",
  "./manifest.json",
];
