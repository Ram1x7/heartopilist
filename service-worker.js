...
const CACHE_NAME = "hatopi-v2.377.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=59",
  "./locales/en.json?v=59",
  "./locales/ko.json?v=59",
  "./locales/th.json?v=59",
  "./locales/zh-CN.json?v=59",
  "./locales/zh-TW.json?v=59",
  "./manifest.json",
];
