...
const CACHE_NAME = "hatopi-v2.195.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=28",
  "./locales/en.json?v=28",
  "./locales/ko.json?v=28",
  "./locales/th.json?v=28",
  "./locales/zh-CN.json?v=28",
  "./locales/zh-TW.json?v=28",
  "./manifest.json",
];
