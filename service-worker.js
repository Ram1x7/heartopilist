...
const CACHE_NAME = "hatopi-v2.233.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=38",
  "./locales/en.json?v=38",
  "./locales/ko.json?v=38",
  "./locales/th.json?v=38",
  "./locales/zh-CN.json?v=38",
  "./locales/zh-TW.json?v=38",
  "./manifest.json",
];
