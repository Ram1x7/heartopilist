...
const CACHE_NAME = "hatopi-v2.324.0";
...
const CACHE_FILES = [
  ...
  "./js/data-updates.js",
  "./js/data-map.js",
  "./js/data-map-locations.js",
  "./js/data-map-areas.js",
  "./js/art-config.js",
  "./js/art-masks.js",
  "./js/art-pixelate.js",
  ...
  "./js/music-presets.js",
  "./js/edge-swipe-guard.js",
  "./js/i18n.js",
  "./js/icons.js",
  "./js/icon-size.js",
  "./js/currency-icons.js",
  "./js/sw-register.js",
  "./locales/ja.json?v=57",
  "./locales/en.json?v=57",
  "./locales/ko.json?v=57",
  "./locales/th.json?v=57",
  "./locales/zh-CN.json?v=57",
  "./locales/zh-TW.json?v=57",
  "./manifest.json",
];
