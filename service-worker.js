...
const CACHE_NAME = "hatopi-v2.209.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=32",
  "./locales/en.json?v=32",
  "./locales/ko.json?v=32",
  "./locales/th.json?v=32",
  "./locales/zh-CN.json?v=32",
  "./locales/zh-TW.json?v=32",
  "./manifest.json",
];
