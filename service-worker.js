...
const CACHE_NAME = "hatopi-v2.192.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=26",
  "./locales/en.json?v=26",
  "./locales/ko.json?v=26",
  "./locales/th.json?v=26",
  "./locales/zh-CN.json?v=26",
  "./locales/zh-TW.json?v=26",
  "./manifest.json",
];
