...
const CACHE_NAME = "hatopi-v2.193.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=27",
  "./locales/en.json?v=27",
  "./locales/ko.json?v=27",
  "./locales/th.json?v=27",
  "./locales/zh-CN.json?v=27",
  "./locales/zh-TW.json?v=27",
  "./manifest.json",
];
