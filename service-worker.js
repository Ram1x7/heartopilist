...
const CACHE_NAME = "hatopi-v2.280.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=53",
  "./locales/en.json?v=53",
  "./locales/ko.json?v=53",
  "./locales/th.json?v=53",
  "./locales/zh-CN.json?v=53",
  "./locales/zh-TW.json?v=53",
  "./manifest.json",
];
