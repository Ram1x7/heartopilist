...
const CACHE_NAME = "hatopi-v2.184.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=21",
  "./locales/en.json?v=21",
  "./locales/ko.json?v=21",
  "./locales/th.json?v=21",
  "./locales/zh-CN.json?v=21",
  "./locales/zh-TW.json?v=21",
  "./manifest.json",
];
