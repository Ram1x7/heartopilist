...
const CACHE_NAME = "hatopi-v2.250.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=46",
  "./locales/en.json?v=46",
  "./locales/ko.json?v=46",
  "./locales/th.json?v=46",
  "./locales/zh-CN.json?v=46",
  "./locales/zh-TW.json?v=46",
  "./manifest.json",
];
