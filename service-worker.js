...
const CACHE_NAME = "hatopi-v2.213.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=35",
  "./locales/en.json?v=35",
  "./locales/ko.json?v=35",
  "./locales/th.json?v=35",
  "./locales/zh-CN.json?v=35",
  "./locales/zh-TW.json?v=35",
  "./manifest.json",
];
