...
const CACHE_NAME = "hatopi-v2.286.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=54",
  "./locales/en.json?v=54",
  "./locales/ko.json?v=54",
  "./locales/th.json?v=54",
  "./locales/zh-CN.json?v=54",
  "./locales/zh-TW.json?v=54",
  "./manifest.json",
];
