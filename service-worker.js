...
const CACHE_NAME = "hatopi-v2.253.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=48",
  "./locales/en.json?v=48",
  "./locales/ko.json?v=48",
  "./locales/th.json?v=48",
  "./locales/zh-CN.json?v=48",
  "./locales/zh-TW.json?v=48",
  "./manifest.json",
];
