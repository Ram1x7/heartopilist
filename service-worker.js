...
const CACHE_NAME = "hatopi-v2.247.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=44",
  "./locales/en.json?v=44",
  "./locales/ko.json?v=44",
  "./locales/th.json?v=44",
  "./locales/zh-CN.json?v=44",
  "./locales/zh-TW.json?v=44",
  "./manifest.json",
];
