...
const CACHE_NAME = "hatopi-v2.252.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=47",
  "./locales/en.json?v=47",
  "./locales/ko.json?v=47",
  "./locales/th.json?v=47",
  "./locales/zh-CN.json?v=47",
  "./locales/zh-TW.json?v=47",
  "./manifest.json",
];
