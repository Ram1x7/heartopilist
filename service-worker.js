...
const CACHE_NAME = "hatopi-v2.257.0";
...
const CACHE_FILES = [
  ...
  "./js/sw-register.js",
  "./locales/ja.json?v=49",
  "./locales/en.json?v=49",
  "./locales/ko.json?v=49",
  "./locales/th.json?v=49",
  "./locales/zh-CN.json?v=49",
  "./locales/zh-TW.json?v=49",
  "./manifest.json",
];
